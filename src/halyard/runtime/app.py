...
from halyard.core.axes import Axis, AxisRegistry
...
from halyard.core.composition.registry import ENTRY_POINT_GROUP
from halyard.core.context import use_correlation_id
...
class App:
    ...
    def axis(self, name: str, *, default: str | None = None) -> AxisHandle:
        ...
        """
        var: ContextVar[str | None] = ContextVar(f"halyard_axis_{name}", default=default)
        axis = (

...
SPAN_ATTEMPT: Final = "halyard.attempt"
#: Attempt number attribute (on attempt spans and backoff events).
ATTR_ATTEMPT_NUMBER: Final = "halyard.attempt.number"
#: Event emitted right before a retry backoff sleep.
EVENT_RETRY_BACKOFF: Final = "halyard.retry.backoff"
#: Backoff delay attribute, seconds.
ATTR_BACKOFF_DELAY: Final = "halyard.backoff.delay"
#: Event emitted when the circuit breaker rejects a call.
EVENT_BREAKER_REJECTED: Final = "halyard.circuit_breaker.rejected"
#: Breaker state attribute on rejection events ("open" | "half_open").
ATTR_BREAKER_STATE: Final = "halyard.circuit_breaker.state"

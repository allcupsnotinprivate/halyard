...
def build_server(app: App, *, name: str = "halyard", version: str = "0") -> Server[Any]:
    ...
    async def on_call_tool(ctx: Any, params: mt.CallToolRequestParams) -> mt.CallToolResult:
        ...
        return mt.CallToolResult(
            ...
            meta={"halyard.source": outcome.source, "halyard.degraded": outcome.degraded},
        )
...
async def run_stdio(
    app: App, *, name: str = "halyard", version: str = "0"

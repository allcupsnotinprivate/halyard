...
from halyard.core.component import AComponent, describe
from halyard.core.component.descriptor import BUILTIN_LINK_MODELS
from halyard.core.component.policy import EffectivePolicy
from halyard.core.component.settings import build_config_model
from halyard.core.composition.endpoint import endpoint_axis, use_endpoint
from halyard.core.composition.wiring import make_base, method_factories
from halyard.core.context import InvocationContext, use_context
from halyard.core.errors import DefaultErrorClassifier, ErrorClassifier
...
async def drive_policy(
    ...
    *,
    ...
    :mod:`~halyard.core.testing.scenarios` builders for ``base`` to check how a
